Markdown# 🏋️‍♂️ Fitness.AI - Microservices Platform
...
```text
         ...
         v                       v                       v
+-----------------+     +-----------------+     +-----------------+
|  Eureka Server  |     |  User Service   |     |Activity Service |
